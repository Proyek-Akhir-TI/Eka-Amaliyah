...
<?php $this->load->view('template/topbar');?>
              ...
              <div class="card mb-4">
                ...
                <form action="<?php echo base_url();?>Bendahara/insert_pembayaran" method="post">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select name="id_siswa" id="id_siswa" onchange="return autofill();" class="form-control">
                           
                            
                                  <option value="<?php echo set_value('id_siswa'); ?>"><?php echo set_value('nisn'); ?> - <?php echo set_value('nama_siswa'); ?></option>
    ...
    foreach ($record->result() as $b)
    {
        ...
        echo "<option value = '$b->id_siswa'>$b->nisn - $b->nama_siswa</option>";
    }
    ?>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                       ...
                       <input type="text" readonly placeholder="Jurusan" name="jurusan" id="jurusan" class="form-control">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                       ...
                       <input type="text" readonly placeholder="Kelas" name="kelas" id="kelas" class="form-control">
                    ...
                    <input type="hidden" readonly value="<?php echo set_value('nama_siswa');?>" name="nama_siswa" id="nama_siswa" class="form-control">

                    <input type="hidden" readonly value="<?php echo set_value('nisn');?>" name="nisn" id="nisn" class="form-control">

                    <input type="hidden" readonly value="<?php echo set_value('no_telepon_walimurid');?>" name="no_telepon_walimurid" id="no_telepon_walimurid" class="form-control">
