          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                ...
                <div class="card-body">
                <form action="<?php echo base_url();?>Bendahara/update_kelas" method="post">
                    <div class="form-group row">
                      <label for="inputEmail3" class="col-sm-3 col-form-label">Kelas</label>
                      <div class="col-sm-9">
                        <input type="hidden" name="id_kelas" value="<?php echo $jurusan->id_kelas;?>" class="form-control">
                        <input type="text" name="kelas" required class="form-control" placeholder="kelas" value="<?php echo $jurusan->kelas;?>">
