...
<?php $this->load->view('template/topbar');?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Detil Pembayaran</h1>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"><a href="<?php echo base_url();?>Bendahara/hasil_history?idsiswa=<?php echo $idsiswa;?>&semester=<?php echo $semester;?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a></h6>
                </div>
