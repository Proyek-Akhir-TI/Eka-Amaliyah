...
<?php $this->load->view('template/topbar');?>
        ...
        <form action="<?php echo base_url();?>Kepsek/filter_rekapitulasi" method="get">
          ...
          <a href="<?php echo base_url();?>Kepsek/datarekapitulasi" class="btn btn-primary"><i class="fa fa-search"></i> Data Rekapitulasi</a>
          <a href="<?php echo base_url();?>Kepsek/cetak_datarekapitulasi_filter?tanggal=<?php echo $_GET['tanggal'];?>&tanggal_akhir=<?php echo $_GET['tanggal_akhir'];?>" class="btn btn-success"><i class="fa fa-print"></i> Cetak Data Rekapitulasi</a>
          </form> 
