            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"><a href="<?php echo base_url();?>Kepsek/datakaskeluar" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a></h6>
                </div>
